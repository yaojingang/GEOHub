...
| Artifact contracts | Strict schemas plus generated-artifact validation | covered |
...
| Research evidence alignment | 54 papers, two datasets, source-resolved research contexts, diagnosis funnel, and content evidence units | covered |
| Measurement integrity | Eligible/missing/excluded accounting, explicit denominators, platform strata, Wilson intervals, and descriptive causal status | covered |
...
Promotion beyond Experimental requires the missing external evidence and independent review of live-platform behavior. Experimental 0.3.0 source publication remains within the current gate scope.
