...
Each environment also passed 374 router cases, 40 trigger cases, and 30 deterministic output cases with precision, recall, trigger compliance, and contract compliance all at 1.0; fabricated citations remained 0.
