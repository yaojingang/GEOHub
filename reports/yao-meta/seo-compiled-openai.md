...
| --- | --- | --- | --- | --- | --- | --- |
| `openai` | `pass` | OpenAI-style interface metadata plus neutral Agent Skills source | `metadata-adapter` | `none` | `metadata-adapter; keep live evidence missing when browsing is unavailable` | targets/openai/adapter.json, targets/openai/agents/openai.yaml |
