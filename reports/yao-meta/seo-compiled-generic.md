...
| --- | --- | --- | --- | --- | --- | --- |
| `generic` | `pass` | Agent Skills compatible neutral package | `agent-skills-compatible` | `none` | `neutral-source; keep live evidence missing when browsing is unavailable` | targets/generic/adapter.json |
