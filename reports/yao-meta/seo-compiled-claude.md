...
| --- | --- | --- | --- | --- | --- | --- |
| `claude` | `pass` | Claude-compatible neutral source folder with adapter notes | `neutral-source-plus-adapter` | `none` | `neutral-source-plus-adapter; keep live evidence missing when browsing is unavailable` | targets/claude/adapter.json, targets/claude/README.md |
